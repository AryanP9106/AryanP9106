...
with cert_cols:
    for cert in ["FOSSEE Arduino Day 2026 (College Edition)", "Data Science Essentials with Python","AI fluency for students by Anthropic","Claude 101 by Anthropic","Engineering your Future with AWS AI/ML from ICT-Marwadi University"]:
        st.write(f"• {cert}")
with club_cols:
